    ...
    <>
      ...
      <div className="container mx-auto pt-16">
        <div className="mb-12 xl:w-full w-11/12 mx-auto">
          <h1 className="xl:text-5xl text-3xl pt-4 xl:pt-0 text-gray-800 xl:text-left font-extrabold mb-4">
            Popular Blog Posts
          </h1>
          <p className="text-xl text-gray-600 xl:w-7/12 mx-auto xl:mx-0">
            Blogging has turned the publishing world on its head. It allows you
            to write and publish anything, from anywhere, and have it be
            immediately available to billions of people all around the world.
          </p>
        </div>
        <div className="relative bg-center bg-cover bg-no-repeat mb-40 w-11/12 mx-auto xl:w-full h-64">
          ...
          <div className="absolute bottom-0 w-11/12 ml-2 xl:mx-0 lg:mx-0 xl:w-6/12 lg:w-6/12 xl:ml-12 lg:ml-12 rounded-md lg:-mb-56 sm:-mb-48 -mb-64 xl:-mb-24">
            <div className="w-full py-5 px-6 bg-white shadow rounded">
              ...
              <p className="text-xl text-gray-800 font-bold pb-2">
                Productivity tips for effective leaders
              </p>
              <p className="text-base text-gray-600">
                Drop the 9-to-5 Schedule. It's no longer news that the
                traditional 9-to-5 workday is not the optimal productivity time
                span.
              </p>
          ...
          <div className="xl:flex lg:flex sm:flex-1 md:flex flex-wrap justify-between">
            <div className="lg:w-1/2 xl:w-1/4 mx-auto xl:mx-0 md:w-1/2 flex sm:mx-auto mb-6 items-center">
              ...
              <div className="pt-3 pb-3 ml-2 pr-5">
                ...
                <p className="text-base text-gray-800">Enerji</p>
              </div>
            </div>
            <div className="lg:w-1/2 xl:w-1/4 mx-auto xl:mx-0 md:w-1/2 flex sm:mx-auto mb-6 items-center">
              <div className="h-16 w-20">
