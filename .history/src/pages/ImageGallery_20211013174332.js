...
const GridCart = () => {
  return (
    <>
      <div className="relative flex justify filter hover:brightness-75 transition-all ">
        <h3 className="absolute flex bottom-2    left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-2xl font-semibold hover:text-3xl">
          Ticaret
        </h3>
        <img
          className=""
