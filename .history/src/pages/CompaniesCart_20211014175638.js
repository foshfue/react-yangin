      ...
      <div className="relative max-w-7xl mx-auto ">
        ...
        <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none bg">
          {posts.map((post) => (
            <div
              key={post.title}
              className="flex flex-col rounded-lg shadow-lg overflow-hidden bg"
            >
              ...
              <div className="flex-1 bg-white p-6 flex flex-col transition justify-between hover:ease-in-out duration-700">
