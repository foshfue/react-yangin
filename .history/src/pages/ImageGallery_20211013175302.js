  ...
  return (
    <>
      <div className="relative flex justify filter group hover:brightness-75 transition-all ">
        <h3 className="absolute flex bottom-0    left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white  text-3xl font-bold transform group-hover:-translate-y-48">
          Ticaret
        </h3>
        <img
          className=""
