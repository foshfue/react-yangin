  ...
  return (
    <div>
      <div className="header bg-indigo-900 px-16 py-4">
        ...
        <div className="Header-mid grid-cols-3">
          <h1 className="text-7xl text-white font-bold col-span-2 py-16">
            Lorem ipsum dolor sit amet consectetur
          </h1>
          <button className="bg-white text-xl py-2 px-6">call to action</button>
          <h2>world</h2>
        </div>
      </div>
    </div>
