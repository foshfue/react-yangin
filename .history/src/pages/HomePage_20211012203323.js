...
export default function HomePage() {
  return (
    <div className="max-w-screen-2xl flex flex-col justify-center align-middle bg-yellow-400">
      {/* header */}
      ...
      {/* övme partı */}
      <div className="specs w-full "> </div>
      ...
      <div className="sektorlermiz bg-indigo-900 flex flex-col justify-center items-center my-5 px-16">
        ...
        <div className="cartWrapper flex flex-wrap flex-row bg-red-700 items-stretch gap-4 align-middle justify-center">
          <Cart />
          <Cart />
          <Cart />
          <Cart />
