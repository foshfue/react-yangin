...
export default function HomePage() {
  return (
    <div>
      ...
      {/* sektörlerimiz */}
      <div className="sektorlermiz bg-indigo-900 flex flex-col flex-wrap justify-center items-center my-5">
        ...
        <div className="cartWrapper flex w-full p-16 bg-red-600">
          <div className="bg-yellow-600  flex flex-col  w-80">
            <img
              className="rounded-lg w-80 hover:brightness-75 transition-all"
          ...
          <div className="bg-yellow-600 w-80 flex flex-col items-center">
            <img
              className="rounded-lg w-80 hover:brightness-75 transition-all"
              src="https://images.pexels.com/photos/3840441/pexels-photo-3840441.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
              alt="Texxt"
