...
export default function HomePage() {
  return (
    <div className=" max-w-screen-2xl">
      ...
      {/* övme partı */}
      <div className="specs w-full flex  justify-center items-center gap-4">
        <div className="flex flex-col justify-center items-center w-60 p-4 bg-gray-300">
          <img
            className="w-28"
            src="https://threejs-journey.com/assets/images/illustration-webgl.png"
            alt="image1"
          />
          <p className="text-lg">10’dan hazla ülkede</p>
        </div>
        <div className="flex flex-col justify-center items-center w-60 p-4 bg-gray-300">
          <img
            className="w-28"
      ...
      {/* sektörlerimiz */}
      <div className="sektorlermiz bg-indigo-900 flex flex-col justify-center items-center px-16">
