...
export default function HomePage() {
  return (
    <div>
      ...
      {/* sektörlerimiz */}
      <div className="sektorlermiz bg-indigo-900 flex flex-col justify-center items-center">
        <h3 className="text-6xl font-bold text-white ">Sektörlerimiz</h3>
        <p className="text-6xl font-bold text-white ">Sektörlerimiz</p>
      </div>
    </div>
  );
}
