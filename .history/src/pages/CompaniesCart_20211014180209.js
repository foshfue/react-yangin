  ...
  return (
    <div className="relative bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
      ...
      <div className="relative max-w-7xl mx-auto ">
        ...
        <div className="mt-12 max-w-lg mx-auto grid gap-5 group lg:grid-cols-3 lg:max-w-none bg">
          {posts.map((post) => (
            <div
              key={post.title}
              className="flex flex-col rounded-lg shadow-lg overflow-hidden transition-all hover:shadow-xl  group-hover:ease-in-out"
            >
