...
export default function Header() {
  return (
    <Popover className="relative  ">
      <div className="fixed inset-x-0 z-20 flex justify-between bg-white bg-opacity-90 shadow-sm bg-clip-padding items-center px-4 py-6 sm:px-6 md:justify-between md:space-x-10">
