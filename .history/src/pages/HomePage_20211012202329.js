...
export default function HomePage() {
  return (
    <div>
      ...
      {/* sektörlerimiz */}
      <div className="sektorlermiz bg-indigo-900 flex flex-wrap justify-center items-center my-5">
        <h3 className="text-6xl font-bold text-white p-5">Sektörlerimiz</h3>
        <p className="text-lg  text-white py-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p>
        <div className="cartWrapper flex flex-wrap flex-row w-full p-16 bg-red-600 items-stretch gap-4">
          <div className="w-1/3 bg-yellow-400">1</div>
          <div className="w-1/3 bg-yellow-400">1</div>
          <div className="w-1/3 bg-yellow-400">1</div>
          <div className="w-1/3 bg-yellow-400">1</div>
          <div className="w-1/3 bg-yellow-400">1</div>
