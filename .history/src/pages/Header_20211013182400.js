...
export default function Header() {
  return (
    <Popover className="relative   bg-opacity-50 shadow-sm bg-clip-padding">
      <div className="flex justify-between bg-red-500 items-center px-4 py-6 sm:px-6 md:justify-between md:space-x-10">
