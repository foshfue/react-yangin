        ...
        <div className="pb-16 bg-gradient-to-r from-teal-500 to-cyan-600 lg:pb-0 lg:z-10 lg:relative">
          <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-8">
            <div className="relative lg:-my-8">
              <div className="absolute  inset-x-0 top-0 h-1/2 bg-red-400 z-20 lg:hidden" />
              <div className="absolute  inset-x-0 top-0 h-1/3 bg-red-800 z-40 lg:hidden" />
              <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:p-0 absolute z-40 lg:h-full">
                <div className="aspect-w-10 aspect-h-6 rounded-xl z-50 shadow-xl overflow-hidden sm:aspect-w-16 sm:aspect-h-7 lg:aspect-none lg:h-full">
                  <img
                    className="object-cover lg:h-full lg:w-full z-50 "
