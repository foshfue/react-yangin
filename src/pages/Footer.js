...
const navigation = {
  Kurumsal: [
    ...
    { name: "Tarihçe", href: "#" },
    { name: "Felsefemiz", href: "#" },
    { name: "Bize Ulaşın", href: "#" },
  ],
  sirketler: [
    { name: "Say Textil", href: "#" },
    { name: "Say Kabol", href: "#" },
    { name: "Say Enerji", href: "#" },
    { name: "Say İnşaat", href: "#" },
  ],
  hizmetler: [
    { name: "Fit-Out", href: "#" },
    { name: "Enerji", href: "#" },
    { name: "Danışmalık", href: "#" },
    { name: "İnşaat", href: "#" },
    { name: "Kablo", href: "#" },
  ],
  yasal: [
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2020 Saygin, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
